...
@section('content')
                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="company_name" name="company_name"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control fs-5" id="company_email" name="company_email"
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control fs-5" id="company_phone" name="company_phone"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="website" name="website"
 ...
 <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="facebook_url" name="facebook_url"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="linkedin_url" name="linkedin_url"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="instagram_url" name="instagram_url"
                         ...
                         <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="twitter_url" name="twitter_url"
