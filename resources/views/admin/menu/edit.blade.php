                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control fs-5" id="title" name="title" value="{{ $menuData->title }}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                    ...
                                    <input type="text" class="form-control fs-5" id="link" name="link" value="{{ $menuData->link }}">
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <textarea  class="form-control fs-5" name="position" rows="4" required>{{ $menuData->position }}</textarea>
                            </div>
                        </div>
                       
                <div class="col-md-4"> 
                        <div class="form-group">
                            <label for="section">@lang('app.menus.section')</label>
                    <select name="section"id="section" class="form-control fs-5">
