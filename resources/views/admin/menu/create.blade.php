                ...
                <form id="editSettings" class="ajax-form">
                    ...
                    <div class="col-md-4"> 
                        <div class="form-group">
                            ...
                            <input type="text" id="title" name="title" class="form-control fs-5">
                        </div>
                    </div>  
                    <div class="col-md-4"> 
                        <div class="form-group">
                            <label for="link">@lang('app.menus.link')</label>
                            <input type="text" id="link" name="link" class="form-control fs-5">
                        </div>
                    </div>
                    <div class="col-md-4"> 
                        <div class="form-group">
                            <label for="position">@lang('app.menus.position')</label>
                            <textarea id="position" name="position" rows="4" cols="50" class="form-control fs-5"></textarea>
                        </div>
                    </div>
