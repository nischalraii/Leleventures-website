            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="title">@lang('app.partner.image')</label>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="slug" name="slug">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control fs-5" id="url" name="url">
                            </div>
                        </div>
