<div class="sidebar-wrapper scrollbar scrollbar-inner">
    <div class="sidebar-content">
        <ul class="nav nav-secondary">
            ...
            @endif
            @if (in_array('view_services', $userPermissions))
                <li class="nav-item">
            ...
            @if (in_array('view_contact', $userPermissions))
                <li class="nav-item">
            ...
            @endif
            @if (in_array('view_about', $userPermissions))
                <li class="nav-item">
            ...
            @endif
            @if (in_array('view_partner', $userPermissions))
                <li class="nav-item">
                ...
                <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
                    ...
                    <li class="nav-item topbar-user dropdown hidden-caret">
                        <a class="dropdown-toggle profile-pic" data-bs-toggle="dropdown" href="#"
                            aria-expanded="false">
                            <div class="avatar-sm">
                                <img src="{{asset('base/assets/img/profile.jpg')}}" alt="..." class="avatar-img rounded-circle" />
                            </div>
                        ...
                        <ul class="dropdown-menu dropdown-user animated fadeIn">
                            <div class="dropdown-user-scroll scrollbar-outer">
                                <li>
                                    <div class="user-box">
                                        <div class="avatar-lg">
                                            <img src="{{asset('base/assets/img/profile.jpg')}}" alt="image profile"
