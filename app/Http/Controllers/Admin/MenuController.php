...
class MenuController extends AdminBaseController
{
    ...
    public function store(StoreMenu $request)
    {
        ...
        return Reply::redirect(route('admin.menu.index'), __('menu.menus').' '.__('app.messages.createdSuccessfully'));
    }
   ...
   public function data()
   {
    ...
    $menus = Menu::all();
       ...
       return DataTables::of($menus)
           ...
           // Actions for menus
           $action = '<a href="' . route('admin.menu.edit', [$row->id]) . '" class="edit-menu"
